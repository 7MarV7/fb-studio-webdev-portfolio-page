...
export const translations: Translations = {
  ...
  privacyPolicyWhatInfoPersonalText1: {
    ...
    de: 'Wir sammeln persönliche Informationen, die Sie uns freiwillig zur Verfügung stellen, wenn Sie Interesse an Informationen über uns oder unsere Produkte und Dienstleistungen bekunden, wenn Sie an Aktivitäten auf der Website teilnehmen (z. B. Nutzung der KI-Personalisierungsfunktion oder Absenden des Kontaktformulars) oder uns anderweitig kontaktieren.'
  },
  privacyPolicyWhatInfoPersonalText2: {
    ...
    de: 'Die persönlichen Informationen, die wir sammeln, hängen vom Kontext Ihrer Interaktionen mit uns und der Website, den von Ihnen getroffenen Entscheidungen und den von Ihnen genutzten Produkten und Funktionen ab. Die von uns gesammelten persönlichen Informationen können Folgendes umfassen:'
  },
  privacyPolicyWhatInfoProfileUrls: {
    ...
    de: '<strong>Profil-URLs zur Personalisierung:</strong> Wenn Sie unsere KI-Personalisierungsfunktion nutzen, können Sie eine URL zu einem öffentlichen Online-Profil (z. B. LinkedIn) angeben. Diese URL wird zusammen mit bestehenden Portfolioinhalten an einen KI-Dienst (Google Gemini über Genkit) gesendet, um eine personalisierte Einleitung zu generieren. Diese Daten werden zu diesem Zweck verarbeitet und von uns nicht über den unmittelbaren Verarbeitungsbedarf hinaus gespeichert, es sei denn, dies ist gesetzlich vorgeschrieben.'
  },
  ...
  privacyPolicyWhatInfoAutoText: {
    ...
    de: 'Wir sammeln automatisch bestimmte Informationen, wenn Sie die Website besuchen, nutzen oder navigieren. Diese Informationen geben Ihre spezifische Identität nicht preis (wie Ihren Namen oder Ihre Kontaktinformationen), können aber Geräte- und Nutzungsinformationen wie Ihre IP-Adresse, Browser- und Geräteeigenschaften, Betriebssystem, Spracheinstellungen, verweisende URLs, Gerätename, Land, Standort, Informationen darüber, wie und wann Sie unsere Website nutzen, und andere technische Informationen enthalten. Diese Informationen werden hauptsächlich benötigt, um die Sicherheit und den Betrieb unserer Website aufrechtzuerhalten, sowie für unsere internen Analyse- und Berichtszwecke.'
  },
  ...
  privacyPolicyHowInfoText: {
    ...
    de: 'Wir verwenden persönliche Informationen, die über unsere Website gesammelt werden, für eine Vielzahl von unten beschriebenen Geschäftszwecken. Wir verarbeiten Ihre persönlichen Informationen für diese Zwecke unter Berufung auf unsere berechtigten Geschäftsinteressen, um einen Vertrag mit Ihnen abzuschließen oder zu erfüllen, mit Ihrer Zustimmung und/oder zur Erfüllung unserer gesetzlichen Verpflichtungen.'
  },
  ...
  privacyPolicySharedAi: {
    ...
    de: '<strong>KI-Dienstleister:</strong> Für die Personalisierungsfunktion werden die bereitgestellte Profil-URL und der Portfolioinhalt zur Verarbeitung über Genkit mit dem Gemini-KI-Modell von Google geteilt. Wir kontrollieren nicht die anschließende Nutzung dieser Daten durch Google; bitte beachten Sie die Datenschutzrichtlinien von Google.'
  },
  ...
  privacyPolicyKeepInfoText1: {
    ...
    de: 'Wir bewahren Ihre persönlichen Daten nur so lange auf, wie es für die in dieser Datenschutzerklärung dargelegten Zwecke erforderlich ist, es sei denn, eine längere Aufbewahrungsfrist ist gesetzlich vorgeschrieben oder zulässig (z. B. steuerliche, buchhalterische oder andere gesetzliche Anforderungen).'
  },
  privacyPolicyKeepInfoText2: {
    ...
    de: 'Daten, die für die KI-Personalisierungsfunktion bereitgestellt werden, werden von uns nach der Generierung der Personalisierung nicht gespeichert, außer möglicherweise in transienten Protokollen oder gemäß den Bedingungen unseres KI-Dienstleisters.'
  },
  ...
  privacyPolicySafeInfoText: {
    ...
    de: 'Wir haben angemessene technische und organisatorische Sicherheitsmaßnahmen getroffen, um die Sicherheit aller von uns verarbeiteten personenbezogenen Daten zu schützen. Trotz unserer Schutzmaßnahmen und Bemühungen, Ihre Informationen zu sichern, kann jedoch keine elektronische Übertragung über das Internet oder Informationsspeichertechnologie zu 100 % sicher garantiert werden.'
  },
  ...
  privacyPolicyRightsText2: {
    ...
    de: 'Wenn Sie der Datenverarbeitung zugestimmt haben, können Sie diese Einwilligung jederzeit für die Zukunft widerrufen.'
  },
  privacyPolicyRightsText3: {
    ...
    de: 'Um einen solchen Antrag zu stellen, verwenden Sie bitte die unten angegebenen Kontaktdaten. Wir werden jeden Antrag gemäß den geltenden Datenschutzgesetzen prüfen und bearbeiten.'
  },
